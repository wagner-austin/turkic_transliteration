...
# Built per key rather than with dict.fromkeys, which would hand every
# key the same list object.
ANSWERS = {
    **{line: [("__label__kk", 0.99)] for line in _KAZAKH},
    **{line: [("__label__ky", 0.99)] for line in _KYRGYZ},
}
